      ...
      >
        ...
        {postHovered && (
          <div className="absolute top-0 w-full h-full flex flex-col justify-between p-1 pr-2 pt-2 pb-2 z-50">
            ...
            {/*TODO: source image destination url */}
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                ...
                >
                  ...
                  {destination.length > 30
                    ? destination.slice(8, 29)
                    : destination.slice(8)}
                </a>
              )}
              {/*TODO: delete images by id */}
              {postedBy?._id === user?.googleId && (
                <button
                  ...
                  className="bg-white p-2 opacity-70 hover:opacity-100 text-dark font-bold px-5 py-1 text-base rounded-3xl hover:shadow-lg outline-none"
                >
                  <AiTwotoneDelete />
                </button>
              )}
